...
func main() {
	...
	// Test case: Most recent bar is bullish, but earlier bars have bearish setup
	// Current implementation will break at first bullish bar and miss the setup
	fmt.Println("=== Test: Recent bar bullish, earlier bars have setup ===")
	bars := createRecentBreak()
...
func createRecentBreak() map[string][]domain.OHLCV {
	...
	// Create 20 bars:
	// - Bars 0-9: uptrend
	// - Bars 10-17: downtrend (bearish setup of 8 bars)
	// - Bar 18: bullish (breaks sequence)
	// - Bar 19: bearish again
	// The setup should be found in bars 10-17, but current implementation
	// will break at bar 18 and miss it
	prices := []float64{
		10.0, 10.1, 10.2, 10.3, 10.4, // 0-4: uptrend
		10.5, 10.6, 10.7, 10.8, 10.9, // 5-9: uptrend
		10.8, 10.7, 10.6, 10.5, 10.4, // 10-14: downtrend
		10.3, 10.2, 10.1, 10.2, 10.0, // 15-19: downtrend, break at 18, down at 19
	}
