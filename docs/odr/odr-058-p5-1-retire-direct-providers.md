...
> **Related ADRs**: [ADR-022](../adr/adr-022-unified-research-platform.md)（§1 五分区 / L0 唯一数据面 / 单一摄取入口 / 单向依赖 L3→L2→L1→L0）
> **Supersedes**: —
...
| 文件 | 变更 |
|---|---|
| `docs/odr/odr-058-p5-1-retire-direct-providers.md` | **新建**（本记录） |
...
| `docs/RESEARCH.md` | §4 实施路线表加编号口径注（与 ADR-022 阶段编号区分） |
