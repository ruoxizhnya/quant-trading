...
> **Related ADRs**: [ADR-022](../adr/adr-022-unified-research-platform.md)（§2 数据归属 / §3 四层架构「契约优先」/ §4 取数严格单一入口 — 本次落地的依据）
> **Supersedes**: —
...
| **新建** | `docs/odr/odr-052-p1-contract-freeze-and-spot-check.md` | 本文件 |
