...
**AUD 线至此 AUD-01 ~ AUD-60 全部有裁决且已落地（2026-09-26 收尾）。⛔ 新开 AUD-61 一条**
...
只登记、未修，**动之前先裁决**。以下为 2026-09-25 的原始登记（保留经过）：
