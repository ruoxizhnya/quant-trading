...
> **Related ADRs**: [adr-015](adr-015-ai-agent-architecture.md) (AI Agent 架构), [adr-016](adr-016-multi-source-data-architecture.md) (多数据源), [adr-019](adr-019-service-merge-ai-copilot.md) (服务合并), [adr-020](adr-020-engine-decomposition.md) (Engine 分解)
...
| ADR-021 的既有文档引用失效 | 低 | ADR-021 标记 Superseded 并保留；RESEARCH.md 降级为"工作面 1 详案"待修订 |
...
| [RESEARCH.md](../RESEARCH.md) | 工作面 1 详案（Product + Tech），部分内容受本 ADR 修订 |
